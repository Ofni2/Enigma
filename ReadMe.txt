...
AppWizard a créé cette application Enigma pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application Enigma.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) Enigma.pch et un fichier de type précompilé nommé StdAfx.obj.
